...
<div>Meie aadresss: 
    {aadress}
    <button onClick={() => uuendaAadress(aadress.toUpperCase())}>Suureks</button>
    <button onClick={() => uuendaAadress(aadress.toLowerCase())}>Väikesteks</button></div>

<div>Meie email: 
    {n2itaEmaili === false && <button onClick={() => uuendaN2itaEmaili(true)}>Näita email</button>}
